...
import { deleteAuthor, getAuthors } from "../../../_service/authors";
  ...
  const toggleDropdown = (id) => {
   ...
   const handleDelete = async (id) => {
      ...
      if (confirmDelete) {
        ...
        setAuthors(authors.filter((author)=>author.id!== id));  //fitur untuk mengupdate data udari state data 
      }
    }
    ...
    <section className="bg-gray-50 dark:bg-gray-900 p-3 sm:p-5">
      <div className="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-visible">
        ...
        <div className="flex justify-between items-center p-4 text-gray-400 text-sm">
          <span>Showing {filteredAuthors.length} data</span>
