...
import { deleteBook, getBooks } from "../../../_service/books";
...
export default function AdminBooks() {
  ...
  const handleDelete = async (id) => {
    ...
    if (confirmDelete) {
      await deleteBook(id);
      setBooks(books.filter((book)=>book.id!== id));  //fitur untuk mengupdate data udari state data 
    }
  }
      ...
      <section className="bg-gray-50 dark:bg-gray-900 p-3 sm:p-5">
        <div className="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-visible">
          ...
          <div className="flex justify-between items-center p-4 text-gray-400 text-sm">
            <span>Showing {filteredBooks.length} data</span>
