...
import { deleteGenre, getGenres } from "../../../_service/genres";
...
export default function AdminGenres() {
  ...
  const handleDelete = async (id) => {
    const confirmDelete = window.confirm(
      "apakah kamu yakin ingin menghapus genre ini ",
    );

    if (confirmDelete) {
      await deleteGenre(id);
      setGenres(genres.filter((genre) => genre.id !== id)); //fitur untuk mengupdate data udari state data
    }
  };
    ...
    <section className="bg-gray-50 dark:bg-gray-900 p-3 sm:p-5">
      <div className="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-visible">
        ...
        <div className="flex justify-between items-center p-4 text-gray-400 text-sm">
          <span>Showing {filteredGenres.length} data</span>
